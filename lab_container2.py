...
# hosts
host1 = net.addHost('host1', ip='10.0.2.10', mac='00:00:00:00:00:01', )
host2 = net.addHost('host2', ip='10.0.2.20', mac='00:00:00:00:00:02', )
...
host2.setDefaultRoute('via 10.0.0.1')
...
# controller 1 to switch 1 and controller 2 to switch 2
