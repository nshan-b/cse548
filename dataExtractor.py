...
# Define variables
# Data file Path
DatasetPath='/home/ubuntu/lab-cs-ml-00301/NSL-KDD/'
# Data file name
...
if training_attack_class_list[0][0] != 0 and len(training_attack_class_list[0]) != num_attack_class:
    ...
    trainingFileName = trainingFileName + ".csv"
...
if testing_attack_class_list[0][0] != 0 and len(testing_attack_class_list[0]) != num_attack_class:
    for i in range(len(X_test)):
        ...
        for j in range(len(testing_attack_class_list[0])):
            if str.lower(str(X_test[i, -2])) in attacks_subClass[testing_attack_class_list[0][j]-1] or str.lower(str(X_train[i, -2])) == 'normal':
    ...
    testingFileName = testingFileName + ".csv"
